  ...
  nlDigitar(async function(){
    ...
    if(r && r.usuario && r.usuario !== "undefined"){
      ...
      nlMsgLiss("Prontinho" + trata + "! Seu teste grátis está liberado:", function(){
        nlMsgLiss("Usuário: <b>" + nlEscapar(r.usuario) + "</b> · Senha: <b>" + nlEscapar(r.senha) + "</b> · Validade: <b>" + nlEscapar(r.validade_horas || "1") + " hora</b><br><br><button class='chip' onclick='nlCopiarCred(0,this)'>Copiar usuário</button> <button class='chip' onclick='nlCopiarCred(1,this)'>Copiar senha</button>", function(){
