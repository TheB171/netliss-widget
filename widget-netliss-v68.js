...
var NL_UTIL = ["nlMsgLiss","nlMsgUser","nlChips","nlCard","nlForm","nlRolar","nlEscapar","nlSalvar","nlLer",
  ...
  "nlCopiarFallback","nlCopiarOrientacao","nlIniciarPolling",
...
function nlAfiliadoCadastro(){
  ...
  nlMsgLiss("Perfeito! Preencha seus dados para eu criar o seu material de afiliado:", function(){
    nlForm("<input id='nl-af-pix' type='text' placeholder='Chave PIX para pagamentos' maxlength='80'>" +
           ...
           "<input id='nl-af-email' type='email' placeholder='Seu melhor e-mail' maxlength='80'>" +
...
function nlCriarAfiliado(){
  ...
  var _cem = document.getElementById("nl-af-email");
  var email = _cem ? _cem.value.trim() : "";
  ...
  nlMsgUser(nome);
  nlDigitar(async function(){
    var r = await nlApi({ acao:"afiliado_criar", pix:pix, nome:nome, banco:banco, whatsapp:tel, email:email });
...
function nlBootWidget(){
  ...
  var _r = { gclid: params.get("gclid") || "", fbclid: params.get("fbclid") || "", ttclid: params.get("ttclid") || "", gptclid: _gpt, ref: params.get("ref") || "" };
