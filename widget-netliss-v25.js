...
function nlAvisoCompra(seguir){
  nlMsgLiss("Antes de confirmar: a gente libera o teste grátis justamente para você ter certeza de que funciona bem no seu celular antes de gastar qualquer dinheiro. Por isso, depois de confirmado, <b>o pagamento não é devolvido</b>.<br><br>Se ficou alguma dúvida, faz o teste de novo com calma. Ao continuar, você confirma que testou e concorda com essa condição.", function(){
    nlChips([
...
function nlGanharDinheiro(){
  ...
  nlMsgLiss("Que bom que você quer ganhar dinheiro com a gente! São duas formas, e a diferença é simples:", function(){
    nlMsgLiss("<b>AFILIADO</b> — você só divulga o seu link ou QR Code nas suas redes sociais, no seu site, na sua loja, em grupos de WhatsApp, em panfletos, cartazes, cartão de visitas, onde você quiser. Não paga nada e não atende ninguém: nós cuidamos do atendimento, da entrega e do suporte. Você ganha <b>20% da primeira compra</b> de cada cliente que vier pelo seu link — R$4,98 no mensal, R$19,98 no semestral e R$35,98 no anual. E o pagamento é diário: o que vender hoje cai na sua conta amanhã.", function(){
      nlMsgLiss("<b>REVENDEDOR</b> — você tem o seu próprio negócio. Paga uma licença mensal, compra os acessos que for revender a partir de <b>R$2,50</b> e vende pelo preço que quiser. O lucro é bem maior, mas o cliente é seu, e o suporte também: nós damos suporte a você, e você dá suporte aos seus clientes.", function(){
...
function nlRevRegras(){
  ...
  nlMsgLiss("Qual é a modalidade do chip do seu cliente?", function(){
    nlChips([
