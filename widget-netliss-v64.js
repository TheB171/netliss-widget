    ...
    if(r && r.success){
      ...
      nlMsgLiss("Oi, <b>" + nlEscapar(r.nome || "") + "</b>! Aqui está o seu resumo:<br><br>" +
        ...
        nlChips([
          ...
          { rotulo:"Baixar meu QR Code", manter:true, acao:function(){ window.open("https://api.qrserver.com/v1/create-qr-code/?size=500x500&data=" + encodeURIComponent(link), "_blank"); } },
